...
from lotuspay_nach_service.routes.settlements import router as settlements_router
from lotuspay_nach_service.routes.agents import router as agents_router
from lotuspay_nach_service.routes.payments import router as payments_router
...
from lotuspay_nach_service.data.payments_model import (payment_metadata)
...
app.include_router(bank_account_router, prefix="")
...
app.include_router(settlements_router, prefix="")
