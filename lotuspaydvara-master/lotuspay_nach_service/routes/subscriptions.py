...
@router.post("/subscription_cancellation", status_code=status.HTTP_200_OK,  tags=["Subscriptions"])
...
@router.get("/subscriptions_list",status_code=status.HTTP_200_OK, tags=["Subscriptions"])
