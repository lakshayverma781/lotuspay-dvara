...
@router.post("/bank_accounts", response_model=BankAccountDB, status_code=status.HTTP_201_CREATED, tags=["Bank Accounts"])
...
@router.get("/bank_account",status_code=status.HTTP_200_OK, tags=["Bank Accounts"])
...
@router.get("/bank_accounts_list",status_code=status.HTTP_200_OK, tags=["Bank Accounts"])
