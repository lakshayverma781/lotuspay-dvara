...
@router.post("/physical_mandates_image",status_code=status.HTTP_200_OK, tags=["Physical Mandates"] )
async def upload_file(
    ...
    if response_id is not None:
            ...
            insert_query = physical_mandate_image.insert().values(phy_info)
...
@router.get("/physical_mandate_images",status_code=status.HTTP_200_OK, tags=["Physical Mandates"])
...
@router.get("/physical_mandate_image_file", status_code=status.HTTP_200_OK,  tags=["Physical Mandates"])
...
@router.get("/physical_mandate_images_list",status_code=status.HTTP_200_OK, tags=["Physical Mandates"])
