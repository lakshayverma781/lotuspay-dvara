...
@router.post("/customers", response_model=CustomerDB, status_code=status.HTTP_201_CREATED,  tags=["Customers"])
...
@router.get("/customer",status_code=status.HTTP_200_OK, tags=["Customers"])
...
@router.get("/customer_list",status_code=status.HTTP_200_OK, tags=["Customers"])
