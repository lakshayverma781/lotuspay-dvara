...
@router.post("/mandates", response_model=MandateDB, status_code=status.HTTP_201_CREATED,  tags=["Mandates"])
...
@router.post("/mandates_cancellation", status_code=status.HTTP_200_OK,  tags=["Mandates"])
...
@router.post("/mandates_import_external", status_code=status.HTTP_200_OK,  tags=["Mandates"])
